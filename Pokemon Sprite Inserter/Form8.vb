...
Public Class Form8
    ...
    Private Sub InsertTableButtonClick(sender As Object, e As EventArgs) Handles InsertTableButton.Click
        ...
        If ErrorFlag = False Then
            ...
            If FreeSpaceCheckBox.Checked = True Then
                ...
                OWSTableOffset = SearchFreeSpace(StartOffsetTextBox.Text, NumberOfBytes, Form1.FreeSpaceByteValue)
            ...
            If ErrorFlag = False Then
                ...
                If Result = DialogResult.Yes Then
                    ...
                    If WriteData(OWSTableOffset, NumberOfBytes, OWSTableEmptyByteTextBox.Text, 1) Then
                        ...
                        RomFileReadStream.Seek(ToDecimal(Form1.OWSTableListOffset), SeekOrigin.Begin)
                        ...
                        If ErrorFlag = False Then
                            Dim OWSTableListTableOffset As String = ToHex(ToDecimal(Form1.OWSTableListOffset) + OWSTableCount * 4)
    ...
    Private Sub Form8Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BackButton.Enabled = False
        BackButton.Hide()
        StartOffsetTextBox.MaxLength = ToHex(Form1.RomLength).Length
        OWSTableOffsetTextBox.MaxLength = ToHex(Form1.RomLength).Length
    End Sub
